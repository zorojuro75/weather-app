...
// API KEY
const apiKey = "a8f5b7a2ba6be49558787806a1f2302d";
  ...
  return (
    <>
      {invalidCity ? ( // Check if invalidCity is true
        ...
        // if api key is out of limit this will be shown in the page
        <div className="text-xl font-bold text-center">
          This is a free plan. So API key may be out of its limit. In that case,
          you have to wait for the next month.
        </div>
      )}
    </>
  );
